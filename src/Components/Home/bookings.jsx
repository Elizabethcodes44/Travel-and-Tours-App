...
export default function Bookings() {
  ...
  return (
    <div className="p-6  min-h-screen">
      <h2 className="text-5xl  text-center mt-4">My Bookings</h2>
      {bookings.length > 0 ? (
          ...
          <div key={index} className="p-4 mb-4 rounded-lg shadow-md leading-7">
            ...
            {booking.hotel && (
              <div className="mt-4">
                ...
                <p><strong>Name:</strong> {booking.hotel.hotel_name}</p>
                <p><strong>Address:</strong> {booking.hotel.address}</p>
                <p><strong>Rating:</strong> {booking.hotel.review_score}/10</p>
                <p><strong>Price:</strong> {booking.hotel.min_total_price} {booking.hotel.currency}</p>
              </div>
            )}
            <div className="mt-4 flex space-x-4">
              <button
                className="bg-brown text-white text-[20px] rounded-xl py-2 px-4"
